defmodule Identicon do
  ...
  ## Examples
    iex(1)> Identicon.hash_input("banana")
  ...
  ## Examples
    iex(1)> temp = %Identicon.Image{ color: nil , grid: nil , hex: [193, 165, 41, 143, 147, 158, 135, 232, 249, 98, 165, 237, 252, 32, 105, 24] , pixel_map: nil}
    iex(2)> Identicon.pick_color(temp)
  ...
  ## Example
    ...
    iex(1)> "Hi" |> hash_input |> pick_color |> build_grid
  ...
  ## Example
    iex(1)> "Hi" |> hash_input |> pick_color |> build_grid |> filter_odd_squares
    %Identicon.Image{color: {193, 165, 41},
  ...
  ## Example
    iex(1)> "Hi" |> hash_input |> pick_color |> build_grid |> filter_odd_squares |> build_pixel_map
    %Identicon.Image{color: {193, 165, 41},
    grid: [{158, 7}, {232, 11}, {232, 13}, {98, 15}, {98, 19}, {252, 20}, {32, 21},
    {32, 23}, {252, 24}],
    hex: [193, 165, 41, 143, 147, 158, 135, 232, 249, 98, 165, 237, 252, 32, 105,
  ...
  @doc """
  Clone the image or list
  Mirror it
  Append to the right side

  ## Example
    iex(1)> mirror_row([1, 2, 3])
    [1, 2, 3, 2, 1]
  """
